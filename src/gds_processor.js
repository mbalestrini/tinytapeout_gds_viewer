var Module = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      if (Module['locateFile']) {
        var f = 'gds_processor.wasm';
        if (!isDataURI(f)) {
          return locateFile(f);
        }
        return f;
      }
      return new URL('gds_processor.wasm', import.meta.url).href;
    }
    ...
    var _addProcessLayer = (Module['_addProcessLayer'] = wasmExports['A']);
    var _processGDS = (Module['_processGDS'] = wasmExports['B']);
    var _free = (Module['_free'] = wasmExports['C']);
    var _processCells = (Module['_processCells'] = wasmExports['D']);
    var _malloc = (Module['_malloc'] = wasmExports['E']);
    var _setThrew = wasmExports['G'];
    ...
    function applySignatureConversions(wasmExports) {
      ...
      wasmExports['E'] = makeWrapper_pp(wasmExports['E']);
      wasmExports['I'] = makeWrapper_pp(wasmExports['I']);
      wasmExports['J'] = makeWrapper_p(wasmExports['J']);
      return wasmExports;
    }
